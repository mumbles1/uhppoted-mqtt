...
- [HMAC](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/commands/security.md#hmac)
- [Authentication](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/commands/security.md#authentication)
    - [HOTP](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/commands/security.md#hotp)
    - [RSA](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/commands/security.md#rsa)
- [Authorisation](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/commands/security.md#authorisation)
