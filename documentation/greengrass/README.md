...
Installing _uhppoted-mqtt_ is straightforward and described in the [README](https://codeberg.org/uhppoted/uhppoted-mqtt#installation), 
...
the _uhppoted-mqtt_ `thing` (see [Provision a thing device for uhppoted-mqtt](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/greengrass/provisioning.md#provision-a-thing-device-for-uhppoted-mqtt)). Copy the certificates
and key to:
...
_tl;dr; The documentation folder contains a [sample script](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/uhppoted-setup.sh) (contributed by Tim Irwin) for provisioning the certificates from the AWS certificate server which can be customized to match your system._
...
3. [AWS Lambda tar.gz](https://codeberg.org/uhppoted/uhppoted-mqtt/blob/main/documentation/aws-lambda-tar.py)
